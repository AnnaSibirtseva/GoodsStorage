...
namespace GoodsStorage
{
    public partial class StorageForm : Form
    {
        ...
        private void SaveCSV_Click(object sender, EventArgs e)
        {
            ...
            newCSV.Text = " Minimum Price";
            newCSV.TextBox.Text = "Enter the minimum price which users have paid for orders";
            Font font = new Font(newCSV.TextBox.Font.FontFamily, 12.0F);
        ...
        private static void SavedAll(Folder folder)
        {
            ...
            {
                if (folder.AllNodes[i] is Folder && !(folder.AllFolders.Contains(folder.AllNodes[i] as Folder)))
                {
                ...
                else if (folder.AllNodes[i] is Item && !(folder.AllItems.Contains(folder.AllNodes[i] as Item)))
                {
        ...
        /// <summary>
        /// Method to load saved data in tha beginning.
        /// </summary>
        /// <param name="treeView">Current TreeView to add nodes to.</param>
        private static void LoadInfoInBegin(TreeView treeView)
        {
        ...
        private void StorageForm_Activated(object sender, EventArgs e)
        {
            ...
            DefectiveItemCSV.Click += DefectiveItemCSV_Click;
            ...
            LoadInfoInBegin(TreeView);
        }
        /// <summary>
        /// Method for creating a CSV report with defective items.
        /// </summary>
        private void DefectiveItemCSV_Click(object sender, EventArgs e)
        {
            NewFolder CSVReport = new NewFolder();
            CSVReport.Text = " Defective Product";
            CSVReport.TextBox.Text = "Enter the name of the defective product";
            Font font = new Font(CSVReport.TextBox.Font.FontFamily, 13.0F);
            CSVReport.TextBox.Font = font;
            NewFolder.ForCSVDefectiveItems = true;
            CSVReport.ForCSVFiles = true;
            CSVReport.ShowDialog();
        }
        /// <summary>
        /// Method for showing users information in the other form.
        /// </summary>
        private void UserInfo_Click(object sender, EventArgs e)
        {
            ManageUsersForm manageForm = new ManageUsersForm();
            manageForm.Show();
        }
        /// <summary>
        ...
        private void SaveTimer_Tick(object sender, EventArgs e)
        {
            ...
            Saving.Text = " Last Save At " + DateTime.Now.ToString("HH:mm:ss");
            SaveTimer.Start();
        }
    }
}
